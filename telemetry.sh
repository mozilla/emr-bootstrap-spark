...
$HOME/anaconda/bin/pip install rpy2 python_moztelemetry python_mozaggregator montecarlino py4j==0.8.2.1 pyliblzma==0.5.3 plotly==1.6.16
...
wget https://raw.githubusercontent.com/vitillo/emr-bootstrap-spark/master/Unified%20Telemetry-FHR%20Hello%20World.ipynb
